...
import com.dormitorySystem.po.Admin;
import com.dormitorySystem.po.PageInfo;
import com.dormitorySystem.po.Student;
import com.dormitorySystem.service.AdminService;
import com.dormitorySystem.service.StudentService;
import com.dormitorySystem.util.MD5Util;
...
public class AdminController {
	...
	public String login( Admin admin, Model model, HttpSession session, HttpServletRequest request) {
		...
		if ("admin".equals(admin.getRole())) {
			...
			student.setS_username(admin.getA_username());
			student.setS_password(MD5Util.MD5EncodeUtf8(admin.getA_password()));
			Student student1 = studentService.login(student);
			if (student1 != null) {
				session.setAttribute("ad", student1);
				return "studenthome";
			}
