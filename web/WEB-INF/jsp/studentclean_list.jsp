...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.dormitorySystem.po.StudentClean" %>
        ...
        <c:forEach items="${di.list}" var="di">
            <tr>
                ...
                <td>
                    ...
                    <a title="删除" id="delOn" onclick="member_del(this,'${di.g_id}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
        ...
        window.onload = function() {
            ...
            if (adInfoString) {
                ...
                if (adInfo.hasOwnProperty('s_id')) {
                    ...
                    document.getElementById('addStudnetBtn').style.display = 'none';
                    document.getElementById('updateEdit').style.display = 'none';
                    document.getElementById('delOn').style.display = 'none';
                }
            }
        };
        // 定义获取 Cookie 的函数
